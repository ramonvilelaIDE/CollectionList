...
//        numerosAleatorios.stream()
//                .limit(5) // '5' é a quantidade número que eu quero pegar
//                .collect(Collectors.toSet()) //A operação collect "pega de um lugar e coloca em outro"
//                .forEach(System.out::println);//Aqui ele só imprimiu quatro elementos, porque o numero '1' foi repetido. O set não repete elementos.
